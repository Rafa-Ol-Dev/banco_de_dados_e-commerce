...
VALUES
    ('Maria da Silva', '12345678901', '1990-01-15', 'maria.silva@email.com', '41987654321', NULL, 'Rua das Flores', '123', 'Jardim Primavera', NULL, 'Casa 5', 'São Paulo', 'SP', '04567090'),
    ('José Pereira', '98765432102', '1985-06-20', 'jose.pereira@email.com', '41998765432', NULL, 'Avenida Central', '456', 'Centro', 'Bloco 2, Ap 202', 'Rio de Janeiro', 'RJ', '20030050'),
    ...
    ('Fernando Pereira', '98765432106', '1983-07-05', 'fernando.pereira@email.com', '41998765436', '51987654347', 'Alameda dos Ipês', '654', 'Alphaville', 'Apartamento 105', 'Barueri', 'SP', '06455000'),
    ...
    ('Ricardo Santos', '98765432108', '1987-11-30', 'ricardo.santos@email.com', '41998765438', NULL, 'Avenida dos Bandeirantes', '753', 'Moema', 'Bloco 1, Ap 301', 'São Paulo', 'SP', '04108000'),
    ...
    ('Fernando Oliveira', '98765432112', '1984-12-10', 'fernando.oliveira@email.com', '41998765412', '51987654322', 'Alameda das Magnólias', '456', 'Aldeota', NULL, 'Fortaleza', 'CE', '60170040'),
    ...
    ('Lucas Pereira', '98765432114', '1988-09-05', 'lucas.pereira@email.com', '41998765444', '51987654355', 'Avenida das Begônias', '852', 'Itaim Bibi', 'Casa 1', 'São Paulo', 'SP', '04570020'),
...
INSERT INTO produto (Nome, Categoria, Descricao, Preco_unitario, Possui_garantia_estendida, Avaliacao, Dimensoes) values
    ...
    ('Smart TV LED 55" 4K Ultra HD', 'Eletrônicos', 'Smart TV LED 55" 4K Ultra HD com HDR e Dolby Vision - Controle de Voz e Streaming', '1899.00', 'Sim', '4.8', '124 x 75 x 9 cm'),
    ...
    ('Câmera DSLR Canon EOS 90D', 'Fotografia', 'Câmera DSLR Canon EOS 90D com Lente EF-S 18-55mm e 32GB de Cartão SD', '1499.99', 'Sim', '4.6', '15 x 10 x 8 cm'),
    ...
    ('Mala de Viagem Rígida', 'Bagagem', 'Mala de Viagem Rígida com 4 Rodas e Capacidade de 28 Litros - Disponível em Diversas Cores', '49.95', 'Sim', '4.4', '50 x 35 x 20 cm'),
    ('Tênis Esportivo Nike Air Max', 'Calçados', 'Tênis Esportivo Nike Air Max com Amortecimento - Disponível em Diversas Cores', '129.00', 'Sim', '4.9', '30 x 15 x 10 cm'),
    ...
    ('Câmera de Segurança Wi-Fi', 'Segurança', 'Câmera de Segurança Wi-Fi com Visão Noturna e Detecção de Movimento - Controle pelo Smartphone', '69.00', 'Sim', '4.5', '10 x 10 x 10 cm'),
    ...
    ('Churrasqueira a Carvão', 'Casa e Jardim', 'Churrasqueira a Carvão com Grelha de 55 cm e Rodinhas - Ideal para Churrascos em Família', '149.99', 'Sim', '4.8', '70 x 50 x 30 cm'),
